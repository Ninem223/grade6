...
def load_questions():
    ...
    try:
        ...
        # True question numbers from the full Google Sheet: 1, 2, 3 ... 60
...
with st.sidebar:
    ...
    if df is not None and len(df) > 0 and st.session_state.started_review:
        ...
        if st.session_state.q_idx < len(df):
            current_question_number = int(df.iloc[st.session_state.q_idx]["Question_Number"])
            st.write(f"Question {current_question_number} of {total_questions_all}")
...
# =========================================================
    ...
    <div class="question-box">
        <div class="question-label">Question {question_number} of {total_questions_all}</div>
