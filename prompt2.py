...
# =========================================================
    ...
    if st.session_state.results:
        ...
        m4.metric("High Harm Flags", int(severe_harm_count))
        ...
        wide_df = raw_df.pivot(
            ...
            values=["Accuracy", "Utility", "Level_of_Detail", "Harm_Level", "Hallucination"]
        )
        ...
        st.download_button(
            ...
            f"results_part_{APP_PART}_questions_{first_q}_to_{last_q}.csv",
            "text/csv",
            use_container_width=True
        )
    else:
